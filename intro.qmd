...
description: "An overview of high-performance computing (HPC) in R: big data, serial vs. parallel computing, CPUs vs. GPUs, key vocabulary, and when parallelizing pays off."
---
...
![Source: Original figure from LUMI consortium documentation [@lumi2023]](fig/socket-core-threads.png){style="text-align: center"}
