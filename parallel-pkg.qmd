...
description: "Parallel computing in R with the parallel package: PSOCK and fork clusters, parLapply, mclapply, and reproducible parallel random numbers, with examples."
---
