---
description: "RAII and scoping in C++ for R users: using object lifetimes to manage resources in Rcpp code, including multi-threaded code and multiple compiled libraries."
---
