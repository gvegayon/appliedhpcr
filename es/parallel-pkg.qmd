...
El lector puede notar que pre-generamos un vector con semillas para cada simulación. Si bien esta no es una práctica común cuando en computación serial, como veremos, es una estrategia común para asegurar la reproducibilidad en computación paralela. 
...
Ambos enfoques son válidos. Las semillas por simulación son especialmente útiles cuando quieres resultados que sean invariantes al número de hilos, por ejemplo, al depurar o comparar ejecuciones entre diferentes máquinas. Las dos estrategias también se pueden usar juntas: `clusterSetRNGStream` para inicializar los workers y semillas por simulación para reproducibilidad estricta entre diferentes configuraciones.
:::
